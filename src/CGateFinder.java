public class CGateFinder {
  ...
  public static void main(String[] args) {
    ...
    // need two independent/non-trivial samples of the desired rotation
    start1 = new Bloch(1, 0, 0);
    target1 = start1.H().S();
    start2 = new Bloch(-2, -1, 0);
    target2 = start2.H().S();
...
//  target2 = new Bloch(1, 0, 0);
    ...
    for (int i = 0; i < 40; i++) {
      Path res = findRoute(i, start1, start1, start2, start2, "");
